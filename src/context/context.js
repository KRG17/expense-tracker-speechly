...
export const Provider = ({ children }) => {
  /*useReducer->An alternative to useState. useReducer is usually preferable to useState when you have complex state logic that involves multiple sub-values.*/

  const [transactions, dispatch] = useReducer(contextReducer, initialState); //state is transactions here
